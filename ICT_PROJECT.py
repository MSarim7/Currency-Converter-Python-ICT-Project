from tkinter import Tk, StringVar, ttk  #To make application with GUI in Python
from tkinter import *
import tkinter.messagebox          # For Message Box
import time                        # For Date and Time
import requests as req             # To Make Http requests to specified URL using GET
from bs4 import *                  # To Pull Data out of HTML files
...
class currency_converter:
    ...
    def __init__(self, BaseAll):
        ...
        self.BaseAll.geometry("1420x710+0+0") #height and width of our main screen
        ...
        outputcm=DoubleVar()
        output_t=DoubleVar()
        insert_value.set("Insert Value here")
        ...
        # Prints date
        self.date_title = Label(Frame_2Top, font = ('Mongolian Baiti', 20, 'bold'), text = "Today's Date", padx = 2, pady = 10, bg = "#3AAFA9", fg = "#DEF2F1", bd = 2, width = 18)
        ...
        # making a box in gui which the converted value of our currency
...
if __name__ == "__main__":
    BaseAll = Tk()                  
    app_main_converter = currency_converter(BaseAll) #calling the object of class
    BaseAll.mainloop() #loop for the gui
